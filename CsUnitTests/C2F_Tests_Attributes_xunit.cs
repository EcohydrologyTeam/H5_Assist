...
namespace C2F_Tests
{
  [Trait("xunit: All", "")]
  [Trait("xunit: C2F All", "")]
  [Trait("xunit: C2F Attributes", "")]
  public class C2F_Tests_Attributes_xunit
  {
    int infile_id = 0;
    int outfile_id = 0;
    int ingroup_id = 0;
    ...
    public C2F_Tests_Attributes_xunit()
    {
    ...
    [Fact]
    [Trait("xunit: C2F Read", "")]
    [Trait("xunit: C2F Scalar", "")]
    public void C2F_Test_h5_read_attri_scalar_r()
    {
      ...
      Assert.Equal(810.03796, Math.Round(attri_value, 5));
    ...
    public void C2F_Test_h5_read_attri_1d_array_r()
    {
      ...
      Console.WriteLine("Condition = " + is_ok);
      Assert.True(is_ok);
      Assert.Equal(Math.Round(3.3, 1), Math.Round(hdf_array[2], 1));
    ...
    public void C2F_Test_h5_read_attri_scalar_c()
    {
      ...
      Assert.True(is_ok);
      Assert.Equal("m3/s", attri_value.Trim());
